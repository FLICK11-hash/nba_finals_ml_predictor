...
def train_final_models(matchups, output_dir):
    ...
    train = matchups[(matchups["year"] >= 1974) & (matchups["year"] <= 2015)].copy()
...
# 1974,Celtics,1,98.6,95.1,1,56,0,0,3,1,1,0.000,0.456,0.800,0
# 1974,Bucks,0,98.6,93.6,1,59,1,0,1,1,1,0.000,0.492,0.763,0
# 1975,Warriors,1,100.4,97.3,1,48,0,0,2,0,0,0.000,0.465,0.768,0
# 1975,Bullets,0,98.0,91.3,1,60,0,0,2,1,0,0.000,0.462,0.752,0
